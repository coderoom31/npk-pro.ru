                                        ...
                                        <?php if (!empty($item['name'])) { ?>
                                            <div class="intec-grid-item">
                                                ...
                                                <?= Html::tag('div', $item['name'], [
                                                    ...
                                                    'style' => [
                                                        'font-size' => !empty($data['description']['text']['size']) ? $data['description']['text']['size'] : null,
                                                        'font-style' => $data['description']['style']['italic'] ? 'italic' : null,
                                                        'font-weight' => $data['description']['style']['bold'] ? '700' : null,
                                                        'color' => !empty($data['description']['text']['color']) ? $data['description']['text']['color'] : null,
                                                        'text-decoration' => $data['description']['style']['underline'] ? 'underline' : null,
                                                        'text-align' => !empty($data['description']['text']['align']) ? $data['description']['text']['align'] : null,
                                                        'opacity' => !empty($data['description']['opacity']) ? $data['description']['opacity'] : null
                                                    ]
                                                ]) ?>
                                            </div>
                                        <?php } ?>
