            ...
            <?php if (!empty($arResult['CONTACT'])) { ?>
                <?php if (
                    ...
                    <?= Html::beginTag('div', [
                        ...
                        <div class="contacts-contact-with-map-wrapper">
                            <div class="contacts-contact-wrapper intec-grid intec-grid-a-h-center intec-grid-a-v-stretch intec-grid-i-h-12 intec-grid-1000-wrap">

								<?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array(
								   "AREA_FILE_SHOW" => "file",
										"PATH" => "/include/contacts/img.php",
								   "EDIT_TEMPLATE" => ""
								   ),
								   false
								);?>
                                <?php if (!empty($arResult['CONTACT']['DATA']['ADDRESS'])) { ?>
                                    <div class="contacts-contact-parameter intec-grid-item-4 intec-grid-item-1000-2 intec-grid-item-700-1">
                                        <div class="contacts-contact-parameter-wrapper intec-grid intec-grid-a-v-center intec-grid-a-v-center intec-grid-i-h-12">
                                            <div class="intec-grid-item-auto">
                                                <?= Html::tag('div', null, [
                                                    'class' => 'contacts-contact-icon',
                                                    'style' => [
                                                        'background-image' => 'url(\''.$this->GetFolder().'/images/location.png\')'
                                                    ]
                                                ]) ?>
                                            </div>
                                        ...
                                        <div class="contacts-contact-parameter-wrapper intec-grid intec-grid-a-v-center intec-grid-a-v-center intec-grid-i-h-12">
                                            <div class="intec-grid-item-auto">
                                                <?= Html::tag('div', null, [
                                                    'class' => 'contacts-contact-icon',
                                                    'style' => [
                                                        'background-image' => 'url(\''.$this->GetFolder().'/images/phone.png\')'
                                                    ]
                                                ]) ?>
                                            </div>
                                            <div class="intec-grid-item">
                                        ...
                                        <div class="contacts-contact-parameter-wrapper intec-grid intec-grid-a-v-center intec-grid-a-v-center intec-grid-i-h-12">
                                            <div class="intec-grid-item-auto">
                                                <?= Html::tag('div', null, [
                                                    'class' => 'contacts-contact-icon',
                                                    'style' => [
                                                        'background-image' => 'url(\''.$this->GetFolder().'/images/time.png\')'
                                                    ]
                                                ]) ?>
                                            </div>
                                            <div class="intec-grid-item">
                                        ...
                                        <div class="contacts-contact-parameter-wrapper intec-grid intec-grid-a-v-center intec-grid-a-v-center intec-grid-i-h-12">
                                            <div class="intec-grid-item-auto">
                                                <?= Html::tag('div', null, [
                                                    'class' => 'contacts-contact-icon',
                                                    'style' => [
                                                        'background-image' => 'url(\''.$this->GetFolder().'/images/email.png\')'
                                                    ]
                                                ]) ?>
                                            </div>
                                            <div class="intec-grid-item">
                                                <div class="intec-grid-item-auto intec-grid-item-shrink-1 contacts-contact-text">
                                                    <div class="contacts-contact-title">
                                                        <?= Loc::getMessage('C_NEWS_LIST_CONTACTS_PROPERTY_EMAIL') ?>:
                                                    </div>
                                                    <?= Html::tag('a', $arResult['CONTACT']['DATA']['EMAIL'], [
                                                        'class' => 'contacts-contact-value',
                                                        'href' => 'mailto:'.$arResult['CONTACT']['DATA']['EMAIL'],
                                                        'target' => '_blank'
                                                    ]) ?>
                                                </div>
                                            </div>
            ...
            <?php if ($arResult['MAP']['SHOW']) { ?>
                <script type="text/javascript">
                    template.load(function (data) {
                        ...
                        'name': '[Component] bitrix:news.list (contacts)',
