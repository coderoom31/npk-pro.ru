...
$arTemplateParameters['SUMMARY_FORM_ID'] = [
    'PARENT' => 'DATA_SOURCE',
    'NAME' => Loc::getMessage('C_NEWS_DETAIL_VACANCIES_DETAIL_1_SUMMARY_FORM_ID'),
    'TYPE' => 'LIST',
...
if (!empty($arCurrentValues['SUMMARY_FORM_ID'])) {
    $arTemplateParameters['SUMMARY_FORM_VACANCY'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_VACANCIES_DETAIL_1_SUMMARY_FORM_VACANCY'),
        'TYPE' => 'LIST',
    ...
    $arTemplateParameters['SUMMARY_FORM_TEMPLATE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_VACANCIES_DETAIL_1_SUMMARY_FORM_TEMPLATE'),
        'TYPE' => 'LIST',
