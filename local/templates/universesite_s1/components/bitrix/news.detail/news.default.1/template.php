...
<div class="news-detail" id="<?= $sTemplateId ?>">
    ...
    <?php } ?>
    <?php if ($arVisual['ADDITIONAL']['PRODUCTS_CATEGORIES']['SHOW']) { ?>
        <div class="news-detail-additional news-detail-item">
            <?php include(__DIR__.'/parts/products_categories.php') ?>
        </div>
    <?php } ?>
    <?php if ($arVisual['ADDITIONAL']['PRODUCTS']['SHOW']) { ?>
        <div class="news-detail-additional news-detail-item">
            <?php include(__DIR__.'/parts/products.php') ?>
        </div>
    <?php } ?>
    <?php if ($arVisual['LINKING']['SHOW']) { ?>
        <div class="news-detail-additional news-detail-item">
            <?php include(__DIR__.'/parts/linking.php') ?>
        </div>
    <?php } ?>
