...
<?= Html::beginTag('div', [
    ...
    <div class="intec-content">
        <div class="intec-content-wrapper">
            <div class="catalog-element intec-grid intec-grid-768-wrap">
                <div class="catalog-element-left intec-grid-item-2 intec-grid-item-1100-auto intec-grid-item-768-1">
                ...
                <div class="catalog-element-right intec-grid-item intec-grid-item-768-1">
                    <?= Html::beginTag('div', [
                        'class' => [
                    ...
                    <?php if ($arResult['ACTION'] !== 'none') { ?>
                        <div class="intec-grid-item-auto intec-grid-item-600-1">
                            <div class="intec-grid intec-grid-wrap intec-grid-a-v-center intec-grid-600-wrap-reverse">
                                <div class="catalog-element-purchase intec-grid-item-auto intec-grid-item-600-1">
                                    <?php include(__DIR__.'/parts/purchase.php') ?>
                                </div>
                                <div class="catalog-element-counter intec-grid-item-auto intec-grid-item-600-1">
