...
<?= Html::beginTag('div', [
    ...
    <div class="catalog-element-wrapper">
        ...
        <div class="catalog-element-content">
            <div class="catalog-element-scroll" data-role="scroll">
                <div class="catalog-element-content-wrapper intec-grid intec-grid-768-wrap">
                    ...
                    <div class="catalog-element-content-right intec-grid-item intec-grid-item-768-1">
                        ...
                        <div class="catalog-element-action-block intec-grid intec-grid-wrap intec-grid-768-wrap intec-grid-i-10">
                            ...
                            <?php if ($arResult['ACTION'] !== 'none') { ?>
                                <div class="intec-grid-item-auto intec-grid-item-768-1">
                                    <div class="intec-grid intec-grid-i-v-10 intec-grid-a-v-center intec-grid-a-h-start intec-grid-nowrap intec-grid-1000-wrap">
