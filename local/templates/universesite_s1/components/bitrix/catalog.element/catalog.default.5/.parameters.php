...
if ($arCurrentValues['SHARES_SHOW'] === 'Y') {
    $arTemplateParameters['SHARES_ONLY_ACTIVE_DATE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_DEFAULT_5_SHARES_ONLY_ACTIVE_DATE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
    ];
    ...
    $arTemplateParameters['PROPERTY_SHARES'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_DEFAULT_5_PROPERTY_SHARES'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyLinkedMultiple,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
