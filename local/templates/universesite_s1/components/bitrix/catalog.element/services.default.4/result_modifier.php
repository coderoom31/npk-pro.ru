...
if ($arBlock['ACTIVE']) {
    ...
    $arBlock['HEADER'] = $fGetPropertyValue($arParams['BLOCKS_CERTIFICATES_1_PROPERTY_HEADER']);

    if (empty($arBlock['HEADER']))
        $arBlock['HEADER'] = $arParams['BLOCKS_CERTIFICATES_1_HEADER'];
...
if ($arBlock['ACTIVE']) {
    ...
    $arBlock['TEMPLATE'] = ArrayHelper::fromRange([ 'template.4', 'template.5'], $arParams['BLOCKS_VIDEOS_1_TEMPLATE']);
...
if ($arBlock['ACTIVE']) {
    ...
    $arBlock['TEMPLATE'] = ArrayHelper::fromRange([ 'template.5', 'template.6'], $arParams['BLOCKS_GALLERY_1_TEMPLATE']);
...
if ($arBlock['ACTIVE']) {
    ...
    $arBlock['HEADER'] = $fGetPropertyValue($arParams['BLOCKS_NEWS_1_PROPERTY_HEADER']);

    if (empty($arBlock['HEADER']))
        $arBlock['HEADER'] = $arParams['BLOCKS_NEWS_1_HEADER'];
...
if ($arBlock['ACTIVE']) {
    ...
    $arBlock['HEADER'] = $fGetPropertyValue($arParams['BLOCKS_PROJECTS_2_PROPERTY_HEADER']);

    if (empty($arBlock['HEADER']))
        $arBlock['HEADER'] = $arParams['BLOCKS_PROJECTS_2_HEADER'];
