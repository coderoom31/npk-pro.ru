...
<div class="catalog-element-purchase-block catalog-element-price-credit">
    <?= Html::beginTag( 'div', [
        ...
        'data' => [
            'role' => 'credit',
            'extended' => 'false',
            'status' => $arVisual['CREDIT']['RECALCULATION'] ? "dynamic" : "static"
        ]
    ]) ?>
    <div class="catalog-element-credit-wrapper intec-grid intec-grid-a-v-center">
        ...
        <div class="catalog-element-credit-value">
            <?= Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_3_TEMPLATE_CREDIT_BUY_BY_CREDIT') ?>
            <?= Html::beginTag($arVisual['CREDIT']['LINK']['USE'] ? 'a' : 'span', [
                ...
                <?= Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_3_TEMPLATE_CREDIT_PER') ?>
                <span data-role="price.credit"></span>
                <?= Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_3_TEMPLATE_CREDIT_TIME') ?>
