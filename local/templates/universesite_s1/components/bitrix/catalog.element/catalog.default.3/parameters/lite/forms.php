...
if (!empty($arCurrentValues['FORM_CHEAPER_ID'])) {
    $arTemplateParameters['FORM_CHEAPER_PROPERTY_PRODUCT'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_3_FORM_CHEAPER_PROPERTY_PRODUCT'),
        'TYPE' => 'LIST',
    ...
    $arTemplateParameters['FORM_CHEAPER_TEMPLATE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_3_FORM_CHEAPER_TEMPLATE'),
        'TYPE' => 'LIST',
