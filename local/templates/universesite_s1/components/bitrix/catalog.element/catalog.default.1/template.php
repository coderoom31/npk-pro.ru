                    ...
                    <?php } ?>
                                ...
                                <?php } elseif(!empty($arResult['OFFERS']) || $arResult['SKU_VIEW'] == 'list') { ?>
                                    <div class="catalog-element-information-part intec-grid intec-grid-wrap intec-grid-i-5 intec-grid-a-h-start intec-grid-a-v-center">
                                        ...
                                        <div class="intec-grid-item-auto intec-grid-item-shrink-1">
                                            <div class="intec-ui intec-ui-control-button intec-ui-scheme-current intec-ui-size-5" onclick="template.load(function (data) {
                                                var $ = this.getLibrary('$');
                                                ...
                                                'name': '[Component] bitrix:catalog.element (catalog.default.1) > sku anchor',
