...
$sView = ArrayHelper::fromRange(['1', '2', '3', '4'], $arParams['VIEW']);
...
<?= Html::beginTag('div', [
    'class' => [
        'ns-bitrix',
        'c-sale-products-gift',
        'c-sale-products-gift-template-1'
    ],
        ...
        <div class="sale-products-gift-header" data-entity="header" data-showed="false" style="display: none; opacity: 0;">
            <div class="intec-grid intec-grid-a-v-center">
                <div class="intec-grid-item">
                    <?= Html::tag('div', Loc::getMessage('CT_SPG_TPL_TEXT_HEADER'), [
    ...
    <div class="c-sale-products-gift-items-wrap" data-entity="<?= $sContainerName ?>">
        ...
        <?php if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS'])) {
            ...
            foreach ($arResult['ITEMS'] as &$arItem) {
                ...
                $arItem['LABEL_ARRAY_VALUE'] = array('gift' => $arItem['LABEL_VALUE']);
