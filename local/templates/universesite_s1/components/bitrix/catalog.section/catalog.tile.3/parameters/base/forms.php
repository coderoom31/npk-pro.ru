...
if (!empty($arCurrentValues['ACTION'])) {
    ...
    $arTemplateParameters['FORM_ID'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_TILE_3_FORM_ID'),
        'TYPE' => 'LIST',
    ...
    if (!empty($arForm)) {
        ...
        $arTemplateParameters['FORM_PROPERTY_PRODUCT'] = array(
            'PARENT' => 'BASE',
            'TYPE' => 'LIST',
            'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_TILE_3_FORM_PROPERTY_PRODUCT'),
            'VALUES' => $arFormFields,
            'ADDITIONAL_VALUES' => 'Y'
        );
    ...
    $arTemplateParameters['FORM_TEMPLATE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_TILE_3_FORM_TEMPLATE'),
        'TYPE' => 'LIST',
