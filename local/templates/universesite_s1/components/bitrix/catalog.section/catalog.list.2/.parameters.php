...
if ($arCurrentValues['COUNTER_SHOW'] === 'Y') {
    $arTemplateParameters['RECALCULATION_PRICES_USE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_RECALCULATION_PRICES_USE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
}
...
if ($arCurrentValues['SECTIONS_TIMER_SHOW'] === 'Y') {
    $arTemplateParameters['SECTION_TIMER_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_TIMER_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y',
        'REFRESH' => 'Y'
    ];

    if (!empty($arCurrentValues['SECTION_TIMER_SHOW'] === 'Y')) {
        $arTemplateParameters['TIMER_POSITION'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_TIMER_POSITION'),
            'TYPE' => 'LIST',
            'VALUES' => [
                'left' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_TIMER_POSITION_LEFT'),
                'top' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_TIMER_POSITION_TOP'),
                'right' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_TIMER_POSITION_RIGHT'),
                'bottom' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_TIMER_POSITION_BOTTOM')
            ],
            'DEFAULT' => 'left',
        ];
    }
...
$arTemplateParameters['MEASURE_SHOW'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_MEASURE_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
];
...
$arTemplateParameters['PURCHASE_BASKET_BUTTON_TEXT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_PURCHASE_BASKET_BUTTON_TEXT'),
    'TYPE' => 'STRING',
    'DEFAULT' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_PURCHASE_BASKET_BUTTON_TEXT_DEFAULT')
];

$arTemplateParameters['PURCHASE_ORDER_BUTTON_TEXT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_PURCHASE_ORDER_BUTTON_TEXT'),
    'TYPE' => 'STRING',
    'DEFAULT' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_PURCHASE_ORDER_BUTTON_TEXT_DEFAULT')
];