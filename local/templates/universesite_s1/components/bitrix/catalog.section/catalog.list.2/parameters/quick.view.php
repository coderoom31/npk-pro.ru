...
$arTemplateParameters[$sPrefix.'USE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_QUICK_VIEW_USE'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y',
    'DEFAULT' => 'N'
];
$arTemplateParameters[$sPrefix.'DETAIL'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_QUICK_VIEW_DETAIL'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
];
...
if ($arCurrentValues[$sPrefix.'USE'] === 'Y') {
    $arTemplateParameters[$sPrefix.'SLIDE_USE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_QUICK_VIEW_SLIDE_USE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
    ...
    $arTemplateParameters[$sPrefix.'TEMPLATE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_QUICK_VIEW_TEMPLATE'),
        'TYPE' => 'LIST',
        'VALUES' => $arTemplates,
        'REFRESH' => 'Y'
    ];
    ...
    if (!empty($arCurrentValues['IBLOCK_ID'])) {
        ...
        $arTemplateParameters[$sPrefix . 'PROPERTY_CODE'] = [
            'PARENT' => 'BASE',
            'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_QUICK_VIEW_PROPERTY_CODE'),
            'TYPE' => 'LIST',
            'MULTIPLE' => 'Y',
            'ADDITIONAL_VALUES' => 'Y',
    ...
    if (!empty($sTemplate)) {
        $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
            ...
            function ($sKey, &$arParameter) {
                ...
                $arParameter['NAME'] = Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_QUICK_VIEW').'. '.$arParameter['NAME'];
