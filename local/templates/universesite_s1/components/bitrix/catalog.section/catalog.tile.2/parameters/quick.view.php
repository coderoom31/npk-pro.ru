...
$arTemplateParameters[$sPrefix.'USE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_TILE_2_QUICK_VIEW_USE'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y',
    'DEFAULT' => 'N'
];
$arTemplateParameters[$sPrefix.'DETAIL'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_TILE_2_QUICK_VIEW_DETAIL'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
];
...
if ($arCurrentValues[$sPrefix.'USE'] === 'Y') {
    $arTemplateParameters[$sPrefix.'SLIDE_USE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_TILE_2_QUICK_VIEW_SLIDE_USE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
