...
$arParams['DETAIL_DELIVERY_CALCULATION_USE'] = Properties::get('catalog-delivery-calculation-use') ? 'Y' : 'N';
$arParams['DETAIL_FORM_CHEAPER_SHOW'] = Properties::get('catalog-form-cheaper-show') ? 'Y' : 'N';
