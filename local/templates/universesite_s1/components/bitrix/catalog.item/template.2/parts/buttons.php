...
<?= Html::beginTag('div', [
    ...
    <?php if (!$bOffers) { ?>
        <?php if ($arItem['CAN_BUY']) { ?>
            ...
            <?= Html::endTag('div') ?>
            <?= Html::tag('div', Loc::getMessage('C_CATALOG_ITEM_TEMPLATE_2_TEMPLATE_BASKET_ADDED'), [
                'class' => [
                    'catalog-item-button',
        ...
        <?php } else { ?>
            ...
            <?php } else { ?>
                <?= Html::tag('div', Loc::getMessage('C_CATALOG_ITEM_TEMPLATE_2_TEMPLATE_BASKET_UNAVAILABLE'), [
                    'class' => [
                        'catalog-item-button',
                        'catalog-item-button-default',
        ...
        <?php } ?>
    <?php } else { ?>
        <?= Html::tag('a', Loc::getMessage('C_CATALOG_ITEM_TEMPLATE_2_TEMPLATE_BASKET_DETAIL'), [
            'class' => [
                'catalog-item-button',
                'catalog-item-button-default',
                'intec-cl-background',
