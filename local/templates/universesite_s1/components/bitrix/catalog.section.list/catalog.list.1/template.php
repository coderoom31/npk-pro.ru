            ...
            <?= Html::beginTag('div', [
                ...
                <?= Html::beginTag('div', [
                    ...
                    <?php if ($arVisual['PICTURE']['SHOW']) { ?>
                        <div class="catalog-section-list-item-picture-wrap-1 intec-grid-item-auto intec-grid-item-auto">
                            <?= Html::beginTag('a', [
                    ...
                    <div class="intec-grid-item intec-grid-item">
                        <div class="catalog-section-list-item-section intec-grid intec-grid-a-v-center">
