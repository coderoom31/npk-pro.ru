...
$arParams['TOTAL_WEIGHT_SHOW'] = isset($arParams['TOTAL_WEIGHT_SHOW']) && $arParams['TOTAL_WEIGHT_SHOW'] === 'Y' ? 'Y' : 'N';
$arParams['TOTAL_VOLUME_SHOW'] = isset($arParams['TOTAL_VOLUME_SHOW']) && $arParams['TOTAL_VOLUME_SHOW'] === 'Y' ? 'Y' : 'N';
...
?>
<div class="ns-bitrix c-basket c-basket-template-2" id="<?= $sTemplateId ?>">
