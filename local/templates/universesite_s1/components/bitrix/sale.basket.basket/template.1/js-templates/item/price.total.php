...
<?= Html::beginTag('div', [
    ...
    <div class="intec-grid intec-grid-wrap intec-grid-a-h-end basket-item-total">
        {{#DISCOUNT_PRICE_PERCENT}}
            <div class="intec-grid-item-1 intec-grid-a-h-end basket-item-total-percent">
...
{{#SHOW_DISCOUNT_PRICE}}
<div class="intec-grid-item-1 intec-grid-item-650-auto basket-item-total-economy">
