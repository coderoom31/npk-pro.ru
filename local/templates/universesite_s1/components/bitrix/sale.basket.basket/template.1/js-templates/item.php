                            ...
                            <div class="intec-grid-item-3 intec-grid-item-800-2 intec-grid-item-650-1">
                                <div class="basket-item-main">
                                    <div class="intec-grid intec-grid-425-wrap intec-grid-800-wrap intec-grid-a-h-between">
                                        ...
                                        <div class="basket-item-info-wrap intec-grid-item intec-grid-item-shrink-max intec-grid-item-375-1 intec-grid-item-650 intec-grid-item-800-1">
                                        ...
                                        <div class="basket-item-control-wrap intec-grid-item-auto intec-grid-item-375-1 intec-grid intec-grid-wrap">
                                            <div class="intec-grid-item-1 intec-grid-item-375-auto basket-item-action" data-entity="basket-item-delete" data-item-action="delete">
                                            ...
                                            {{^DELAYED}}
                                            <div class="intec-grid-item-1 intec-grid-item-375-auto basket-item-action basket-item-add-delayed basket-item-delayed-button" data-entity="basket-item-add-delayed" data-item-action="delay">
                                            ...
                                            {{/DELAYED}}
                                            {{#DELAYED}}
                                            <div class="intec-grid-item-1 intec-grid-item-375-auto basket-item-action basket-item-remove-delayed" data-entity="basket-item-remove-delayed">
