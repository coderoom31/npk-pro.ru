    ...
    <?= Html::beginTag('div', [
        ...
        <div class="basket-total-wrapper intec-grid intec-grid-a-h-between intec-grid-1024-wrap">
            <?php if ($arParams['HIDE_COUPON'] !== 'Y') { ?>
                <div class="intec-grid-item-auto intec-grid-item-768-1  intec-grid-item-1024" data-print="false">
            ...
            <div class="intec-grid-item-auto intec-grid-item-900-1">
                <div class="basket-price-wrap intec-grid intec-grid-wrap intec-grid-item-768-2 intec-grid-a-h-1200-between intec-grid-a-h-around">
