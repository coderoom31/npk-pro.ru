    ...
    <form method="post" action="<?= $APPLICATION->GetCurPageParam() ?>" id="<?= $sTemplateId ?>" class="startshop-forms-result-new template-1">
        <div class="startshop-forms-result-new-wrapper">
            ...
            <div class="submit-block">
                <input type="submit" class="startshop-forms-result-new-form-button intec-ui intec-ui-control-button intec-ui-scheme-current intec-ui-size-2" value="<?=$arResult['LANG'][LANGUAGE_ID]['BUTTON']?>"/>
            </div>
        </div>
        <script type="text/javascript">
            (function () {
