        ...
        <?= Html::beginTag('div', [
            ...
            <div class="intec-ui-form-field-content">
                <label class="intec-ui intec-ui-control-checkbox intec-ui-scheme-current">
                    <input type="checkbox" name="PROPERTY_<?= $arProperty['ID'] ?>"<?= $sValue == 'Y' ? ' checked="checked"' : '' ?> />
                ...
                <form method="POST" class="intec-ui-form">
                    ...
                    <div class="startshop-order-content intec-grid intec-grid-1200-wrap intec-grid-i-h-15">
                        ...
                        <div class="startshop-order-summary intec-grid-item-4 intec-grid-item-1200-1">
                            <div class="startshop-order-summary-wrapper">
                                ...
                                <input type="submit" class="intec-ui intec-ui-control-button intec-ui-scheme-current intec-ui-size-5 intec-ui-mod-block"
                    ...
                    <div class="startshop-order-checkout intec-grid">
                        <div class="startshop-order-checkout-button">
                            <input type="submit" class="intec-ui intec-ui-control-button intec-ui-scheme-current intec-ui-size-5"
                                   value="<?= Loc::getMessage('SO_DEFAULT_BUTTONS_ORDER') ?>" />
                        </div>
