                                            ...
                                            <?php if ($arVisual['PRICE']['SHOW'] && !empty($arItem['DATA']['PRICE']['VALUE'])) { ?>
                                                <?= Html::beginTag('div', [
                                                    'class' => Html::cssClassFromArray([
                                                        ...
                                                        'intec-cl-background' => empty($arItem['DATA']['PRICE']['BACKGROUND']['COLOR']) || substr($arItem['DATA']['PRICE']['BACKGROUND']['COLOR'], 0,1) !== '#' || strlen($arItem['DATA']['PRICE']['BACKGROUND']['COLOR']) < 4 || strlen($arItem['DATA']['PRICE']['BACKGROUND']['COLOR']) > 7
                                                    ], true),
                                                    'style' => [
