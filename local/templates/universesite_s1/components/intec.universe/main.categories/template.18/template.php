...
?>
<div class="widget c-categories c-categories-template-18" id="<?= $sTemplateId ?>">
    <div class="widget-wrapper intec-content intec-content-visible">
        <div class="widget-wrapper-2 intec-content-wrapper">
            ...
            <div class="widget-content">
                <div class="widget-items intec-grid intec-grid-wrap intec-grid-i-16" data-columns="<?= $arVisual['COLUMNS'] ?>">
