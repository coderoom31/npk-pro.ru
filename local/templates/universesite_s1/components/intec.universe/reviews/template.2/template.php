...
if (!$arVisual['ITEMS']['HIDE']) {
    $arItemSvg = [
        'RATING' => FileHelper::getFileData(__DIR__.'/svg/item.rating.svg')
    ];
...
?>
<div class="ns-intec-universe c-reviews c-reviews-template-2" id="<?= $sTemplateId ?>">
                        ...
                        <div class="reviews-form-container">
                            <div class="reviews-form-message reviews-form-closed">
                                <?php if (!empty($arVisual['FORM']['AUTHORIZATION'])) { ?>
                                    <?= Loc::getMessage('C_REVIEWS_2_TEMPLATE_1_TEMPLATE_FORM_ACCESS_CLOSED_MACROS', [
                                        '#AUTH#' => $arVisual['FORM']['AUTHORIZATION']
                                    ]) ?>
                                <?php } else { ?>
                                    <?= Loc::getMessage('C_REVIEWS_2_TEMPLATE_1_TEMPLATE_FORM_ACCESS_CLOSED') ?>
                                <?php } ?>
                            </div>
                        </div>
                    <?php } ?>
