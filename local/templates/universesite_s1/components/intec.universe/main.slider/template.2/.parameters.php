...
$arTemplateParameters['LAZYLOAD_USE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_LAZYLOAD_USE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
];
...
if (!empty($arCurrentValues['IBLOCK_ID'])) {
    ...
    $arTemplateParameters['PROPERTY_TEXT_HALF'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_TEXT_HALF'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyCheckbox,
        'ADDITIONAL_VALUES' => 'Y'
    ];
    $arTemplateParameters['PROPERTY_PICTURE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_PICTURE'),
        'TYPE' => 'LIST',
    ...
    if (!empty($arCurrentValues['PROPERTY_PICTURE'])) {
        $arTemplateParameters['PROPERTY_PICTURE_ALIGN_VERTICAL'] = [
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_PICTURE_ALIGN_VERTICAL'),
            'TYPE' => 'LIST',
            'VALUES' => $arPropertyList,
            'ADDITIONAL_VALUES' => 'Y'
        ];
    ...
    $arTemplateParameters['MOBILE_PICTURE_USE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_MOBILE_PICTURE_USE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];
    ...
    if ($arCurrentValues['MOBILE_PICTURE_USE'] === 'Y') {
        $arTemplateParameters['PROPERTY_MOBILE_PICTURE'] = [
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PROPERTY_MOBILE_PICTURE'),
            'TYPE' => 'LIST',
            'VALUES' => $arPropertyFile,
            'ADDITIONAL_VALUES' => 'Y',
            'REFRESH' => 'Y'
...
if (!empty($arCurrentValues['PROPERTY_PICTURE'])) {
    $arTemplateParameters['PICTURE_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_2_PICTURE_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
}
