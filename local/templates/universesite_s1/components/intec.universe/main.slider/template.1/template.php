        ...
        <?= Html::beginTag('div', [
            ...
            <?= Html::beginTag('div', [
                ...
                <?php foreach ($arResult['ITEMS'] as $arItem) {
					...
					$sMobilePicture =  ArrayHelper::getValue($arItem, ['DETAIL_PICTURE', 'SRC']);		
					...
					if (empty($sMobilePicture))
					$sMobilePicture = ArrayHelper::getValue($arItem, ['PREVIEW_PICTURE', 'SRC']); 

                    if (empty($sMobilePicture))
                        $sMobilePicture = SITE_TEMPLATE_PATH.'/images/picture.missing.png';
                ?>

					<?= Html::beginTag('div', [
						'class' => 'bg-slider-mobile',
						'style' => [
						...
						<?= Html::beginTag($sTag, [
							...
							'class' => 'widget-item bg-slider-desktop',
