    ...
    $fRender = function (&$arItem, $bOffer = false) use (&$arVisual) { ?>
        <?= Html::beginTag('div', [
            ...
            <?php if ($arItem['CAN_BUY']) { ?>
                ...
                <?php if ($arVisual['QUANTITY']['MODE'] === 'number') { ?>
                    <?php if ($arItem['CATALOG_QUANTITY'] > 0) { ?>
                        <?= Loc::getMessage('C_WIDGET_PRODUCTS_1_QUANTITY_AVAILABLE').': ' ?>
            ...
            <?php } else { ?>
                ...
                <?= Loc::getMessage('C_WIDGET_PRODUCTS_1_QUANTITY_UNAVAILABLE') ?>
            <?php } ?>
        <?= Html::endTag('div') ?>
    <?php };
