...
if (empty($arResult['FORM']['TITLE']))
    $arResult['FORM']['TITLE'] = Loc::GetMessage('C_WIDGET_FORM_6_TITLE');

if (empty($arResult['FORM']['DESCRIPTION']))
    $arResult['FORM']['DESCRIPTION'] = Loc::GetMessage('C_WIDGET_FORM_6_DESCRIPTION');

if (empty($arResult['FORM']['BUTTON_TEXT']))
    $arResult['FORM']['BUTTON_TEXT'] = Loc::GetMessage('C_WIDGET_FORM_6_BUTTON_TEXT');

if (empty($arResult['FORM']['POPUP_TITLE']))
    $arResult['FORM']['POPUP_TITLE'] = Loc::GetMessage('C_WIDGET_FORM_6_POPUP_TITLE');