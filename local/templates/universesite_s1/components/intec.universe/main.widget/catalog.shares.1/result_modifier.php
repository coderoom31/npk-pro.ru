...
if ($arParams['TEXT_USE'] === 'preview')
    $arVisual['TEXT']['VALUE'] = $arItem['PREVIEW_TEXT'];

if ($arParams['TEXT_USE'] === 'detail')
    $arVisual['TEXT']['VALUE'] = $arItem['DETAIL_TEXT'];
...
if ($arVisual['BUTTON']['SHOW'])
    $arVisual['BUTTON']['VALUE'] = $arParams['BUTTON_TEXT'];
