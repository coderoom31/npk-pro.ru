...
<script type="text/javascript">
    template.load(function (data) {
        ...
        let secondsShow = $(<?= JavaScript::toObject($bShowSeconds) ?>)[0];
        ...
        let aboveZero = true;
        let arDate = $(<?= JavaScript::toObject($arResult['DATE']['VALUE']) ?>);
        ...
        'name': '[Component] intec.universe:product.timer (template.1)',
