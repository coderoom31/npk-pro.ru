...
$APPLICATION->SetPageProperty("description", "Политика конфиденциальности компании NPK PRO. Профессиональное оборудование для агрохимии и электронного учёта сырья");
$APPLICATION->SetPageProperty("title", "Политика конфиденциальности компании NPK PRO");
...
<div class="intec-content">
    <div class="intec-content-wrapper">
        ...
        <p>
            Я, заполняя форму на сайте https://npk-pro.ru/, даю свое согласие администратору сайта https://npk-pro.ru/, в
            ...
            является установление связи с администратором сайта https://npk-pro.ru/, включая направление уведомлений,
        ...
        <p>
            ...
            подтверждаете свое согласие на обработку компанией NPK-PRO персональных данных: сбор,
        ...
        <br>
        <p>
            NPK-PRO гарантирует конфиденциальность получаемой информации. Обработка персональных
            данных осуществляется в целях эффективного исполнения заказов, договоров и иных обязательств, принятых
            компанией NPK-PRO в качестве обязательных к исполнению.&nbsp;
        </p>
        <br>
        <p>
            ...
            согласие на передачу ваших персональных данных. NPK-PRO гарантирует, что
        ...
        <p>
            ...
            направив письменное уведомления на адрес: 308006, г. Белгород, ул. Серафимовича, д. 68А,
        ...
        <p>
            ...
            Вашей учётной записи с Интернет-сайта (<a href="https://npk-pro.ru/">https://npk-pro.ru/</a>), а
            также уничтожение записей, содержащих ваши персональные данные, в системах обработки персональных данных
            компании NPK-PRO, что может сделать невозможным пользование интернет-сервисами компании NPK-PRO.&nbsp;
        </p>
        <br>
        <p>
