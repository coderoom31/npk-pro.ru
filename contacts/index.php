...
$APPLICATION->SetPageProperty("title", "Контакты – Компания NPK-PRO ");
$APPLICATION->SetPageProperty("description", "Контактные данные компании NPK-PRO: адрес, телефон, реквизиты, режим работы. Для подробной информации звоните 89102254955");
$APPLICATION->SetPageProperty("title", "Контакты – Компания NPK-PRO") ?>
<?php
